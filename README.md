...
<h4>Example:</h4>
![Concert this command image](concert.png)
...
<h4>Example:</h4>
![Spotify this song command image](spotify.png)
...
<h4>Example:</h4>
![Movie this command image](movie.png)
...
![Do what it says command image](doIt.png)
